...
<div ng-controller="slideCtrl">
      ...
      <div id="carousel" class="owl-carousel">
        ...
        <div class="carousel-item">
          <div id='cities'>
            ...
            <button ng-click="increment()" class="center-block btn-default next">Next</button>
        ...
        <div class="carousel-item">
          <div class="container" style="height:360px">
            <div class="center-block row">
              ...
              <div class="col-xs-12 col-sm-4">
                <div id="restaurantDiv" class="options activity-div center-block">
          ...
          <button id="goButton" class="btn-default center-block">Go</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="navigation">
    <div ng-show="(page > 0 && locationSelected) || (page == 1 && dateSelected)" ng-click="decrement()" class="arrow arrow-left prev"></div>
    <div ng-show="(page > 1 && page < 2) || (page == 0 && locationSelected) || (page == 1 && dateSelected)" ng-click="increment()" class="arrow arrow-right next"></div>
  </div>
  <div class="push"></div>
</div>
<div>
